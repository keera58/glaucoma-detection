...
#for i in range(1,30):
    img = cv2.imread('C:\\Users\\DELL\\Desktop\\Glaucoma\\Glaucoma-Fundus' + "/" + Data[i])
    R,G,B= cv2.split(img)
    ...
    Cup = cv2.imread("C:\\Users\\DELL\\Desktop\\Glaucoma\\Scripts\\cup.png", 0)
    Disk = cv2.imread("C:\\Users\\DELL\\Desktop\\Glaucoma\\Scripts\\disk.png", 0)
